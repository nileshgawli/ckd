...
sym_des = pd.read_csv(r"E:\BACHELORS MINI PROJECTS\Final\AI-MedLab\backend\HealthPredict\symtoms_df.csv")
precautions = pd.read_csv(r"E:\BACHELORS MINI PROJECTS\Final\AI-MedLab\backend\HealthPredict\precautions_df.csv")
workout = pd.read_csv(r"E:\BACHELORS MINI PROJECTS\Final\AI-MedLab\backend\HealthPredict\workout_df.csv")
description = pd.read_csv(r"E:\BACHELORS MINI PROJECTS\Final\AI-MedLab\backend\HealthPredict\description.csv")
